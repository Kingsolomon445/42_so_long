...
/*   Updated: 2023/06/24 20:38:02 by ofadahun         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	set_up_images(t_mlx *mlx_game)
{
	...
	mlx_game->collectible_img = mlx_texture_to_image(mlx_game->mlx, &(mlx_game->collectible_xpm->texture));
	mlx_resize_image(mlx_game->collectible_img, mlx_game->img_size, mlx_game->img_size);
...
void	set_up_img_pos(t_mlx *mlx_game)
{
	...
	mlx_game->str_img = mlx_put_string(mlx_game->mlx, "Score: 0  Moves: 0", 0, 0);
}
