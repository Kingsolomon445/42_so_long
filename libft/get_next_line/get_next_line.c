...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/03/27 13:03:47 by ofadahun          #+#    #+#             */
/*   Updated: 2023/04/21 15:05:04 by ofadahun         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_next_line(int fd)
{
	...
	{
		if (ft_strchr(buff, '\n'))
			return (extract(line, buff, ft_strchr(buff, '\n')));
		else
			line = join_to_get_complete_line(line, buff, fd);
		if (!line)
			break ;
	}
	return (line);
